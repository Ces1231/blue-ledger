...
const memberSelectCols = `
	m.id, m.chapter_id, m.user_id, m.display_id,
	u.first_name, u.last_name, u.display_name, u.email, u.avatar_url,
	m.role, m.status, m.inducted_year, m.employer, m.title,
	m.city, m.linkedin, m.xp_total, m.xp_semester,
	m.level_key, m.level_key, m.dues_status, m.avatar_bg, m.avatar_fg,
